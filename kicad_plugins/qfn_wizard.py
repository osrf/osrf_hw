...
#        self.AddParam("Pads", "vertical pitch", self.uMM, 14)
        self.AddParam("Pads", "horizontal pitch", self.uMM, 14)
        self.AddParam("Pads", "oval", self.uBool, True)
        self.AddParam("Pads", "epad width", self.uMM, 10)
        self.AddParam("Pads", "epad length", self.uMM, 10)
    ...
    def BuildThisFootprint(self):
        ...
        #thermal pad
        epad = PA.PadMaker(self.module).SMDPad(epad_width, epad_length)
